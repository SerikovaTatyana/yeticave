...
<header class="main-header">
  <div class="main-header__container container">
    ...
    <a href="http://yeticave.loc/index.php" class="main-header__logo">
	...
	<?php if(!empty($_SESSION['login']) && !empty($_SESSION['id'])): ?>
		...
		<!-- <a class="main-header__add-lot button" href="/mysite/yeti_cave/index.php?c=add_lot">Добавить лот</a> -->
		<a class="main-header__add-lot button" href="/index.php?c=add_lot">Добавить лот</a>
		
		<nav class="user-menu">
		  
		  
		    
			<?php foreach( $user_data as $kay => $value): ?>
			
			    <div class="user-menu__image">
					
					<img src="<?php echo $value["avatar"]; ?>" width="40" height="40" alt="Пользователь">
				</div>
				<div class="user-menu__logged">
					<p><a style="font-size: 16px;" href="/index.php?c=personal_area"><?php echo $value["name"]; ?></a></p>
					<a href="/index.php?c=exit">Выйти</a>
			    </div>
	...
	<?php else: ?>
		...
		<nav class="user-menu">
		  <ul class="user-menu__list">
			...
			<li class="user-menu__item">
			  <a href="index.php?c=authorization">Вход</a>
			</li>
		  </ul>
		</nav>
...
<footer class="main-footer">
  <nav class="nav">
    <ul class="nav__list container">
		...
		<?php foreach($all_category as $key => $value): ?>
			...
			<li class="nav__item">
				<!--<a href="index.php?c=category&id_category=1"><?php //echo $value['name_category'] ?></a> -->
				<a href="index.php?c=category&id_category=<?php echo $value["id_category"]; ?>"><?php echo $value['name_category'] ?></a>
			</li>
  ...
  <div class="main-footer__bottom container">
	...
	<?php if(!empty($_SESSION['login']) && !empty($_SESSION['id'])): ?>
		...
		<a class="main-footer__add-lot button" href="/mysite/yeti_cave/mysite/yeti_cave/index.php?c=add_lot">Добавить лот</a>
