<section class="rates container">
    ...
    <table class="rates__list">
      <tbody><tr class="rates__item">
        <td class="rates__info">
          <div class="rates__img">
            <img src="../img/rate1.jpg" alt="Сноуборд" width="54" height="40">
          </div>
      ...
      <tr class="rates__item">
        <td class="rates__info">
          <div class="rates__img">
            <img src="../img/rate2.jpg" alt="Сноуборд" width="54" height="40">
          </div>
      ...
      <tr class="rates__item rates__item--win">
        <td class="rates__info">
          <div class="rates__img">
            <img src="../img/rate3.jpg" alt="Крепления" width="54" height="40">
          </div>
          <div>
      ...
      <tr class="rates__item">
        <td class="rates__info">
          <div class="rates__img">
            <img src="../img/rate4.jpg" alt="Ботинки" width="54" height="40">
          </div>
      ...
      <tr class="rates__item rates__item--end">
        <td class="rates__info">
          <div class="rates__img">
            <img src="../img/rate5.jpg" alt="Куртка" width="54" height="40">
          </div>
      ...
      <tr class="rates__item rates__item--end">
        <td class="rates__info">
          <div class="rates__img">
            <img src="../img/rate6.jpg" alt="Маска" width="54" height="40">
          </div>
      ...
      <tr class="rates__item rates__item--end">
        <td class="rates__info">
          <div class="rates__img">
            <img src="../img/rate7.jpg" alt="Сноуборд" width="54" height="40">
          </div>
          <h3 class="rates__title"><a href="lot.html">DC Ply Mens 2016/2017 Snowboard</a></h3>
        </td>
        <td class="rates__category">
